...
async function execute(items) {
    ...
    for (let i = 0; i < items.length; i++) {
        try {
            ...
            if (!base64Data) {
                throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'No document data provided', {
                    itemIndex: i,
                });
            }
            // Call the auto-detect parse API
            const response = await GenericFunctions_1.parseInvoiceAutoDetect.call(this, base64Data, filename);
            if (!response.success) {
            ...
            if (response.detection) {
                outputData.detection = response.detection;
...
//# sourceMappingURL=parseAutoDetect.operation.js.map